...
public class CustomerRestControllerV1 {
    ...
    // GET customers (Supports full list, sorting, pagination, and combined pagination/sorting)
    @GetMapping
    ...
    // POST create new customer (status 201)
    @PostMapping
    ...
    // DELETE customer (returns structured success message)
    @DeleteMapping("/{id}")
    ...
    // GET advanced search (Exercise 5.3)
